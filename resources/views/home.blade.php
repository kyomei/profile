...
<html lang="pt-br">
    ...
    <head>
        ...
        <script async src="https://www.googletagmanager.com/gtag/js?id=UA-127582230-1"></script>
        <script>
            ...
            gtag('config', 'UA-127582230-1');
        </script>

        <meta charset="utf-8">
        <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
        <meta name="description" content="Portfólio eletrônico de Rafael Jeferson da Silva Pena, Analista de Suporte Ténico  e Web Designer.">
        <meta name="keywords" content="design, web design, criação de site, websites, freelancer, conserto de computador, programador de site, prortfólio eletrônico">
        <meta name="author" content="Rafael Jeferson da Silva Pena">
        ...
        <link href="{{ asset('css/resume.css?version=2') }}" rel="stylesheet"> 
        ...
        <script>(function (w, d, s, l, i) {
            ...
            })(window, document, 'script', 'dataLayer', 'GTM-WD28M8P');</script>
        <!-- End Google Tag Manager -->
    </head>

    <body id="page-top">
        <!-- Google Tag Manager (noscript) -->
        <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-WD28M8P"
